...
class CoreDataStack {
    ...
    func deleteNote(withNName name: String, completion: @escaping () -> Void) {

        let context = CoreDataStack.shared.persistentContainer.viewContext
        let fetchRequest: NSFetchRequest<NotesModel> = NotesModel.fetchRequest()

        fetchRequest.predicate = NSPredicate(format: "nName == %@", name)
    ...
    func deleteTrain(withTTrain name: String, completion: @escaping () -> Void) {

        let context = CoreDataStack.shared.persistentContainer.viewContext
        let fetchRequest: NSFetchRequest<TrainModel> = TrainModel.fetchRequest()

        fetchRequest.predicate = NSPredicate(format: "tTrain == %@", name)
